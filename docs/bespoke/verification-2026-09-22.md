...
| Browser workflow | 17 scenarios passed through the real HTTP handler, including lost replies, stalled requests, wrong codes, dirty reloads, two contexts, history, snapshots, backups, and 390/768/1280-pixel widths |
...
| Public Pages UI and repository proposal receipt | Pending final acceptance; not yet certified by this record |
