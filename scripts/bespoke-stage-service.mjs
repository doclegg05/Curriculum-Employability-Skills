...
for (const rel of ['netlify.toml', 'netlify/functions', 'netlify/site', 'bespoke/selection.schema.json', 'bespoke/selection-v2.schema.json', 'bespoke/builder-model.mjs', 'bespoke/builder-catalog.json', 'bespoke/catalog.json', 'SPOKES Builder/bespoke-library-catalog.json']) {
